...
class PresupuestoDetallesControllerTest < ActionController::TestCase
  ...
  test "should create presupuesto_detalle" do
    assert_difference('PresupuestoDetalle.count') do
      post :create, presupuesto_detalle: { cantidad: @presupuesto_detalle.cantidad, presupuesto_id: @presupuesto_detalle.presupuesto_id }
    end
  ...
  test "should update presupuesto_detalle" do
    patch :update, id: @presupuesto_detalle, presupuesto_detalle: { cantidad: @presupuesto_detalle.cantidad, presupuesto_id: @presupuesto_detalle.presupuesto_id }
    assert_redirected_to presupuesto_detalle_path(assigns(:presupuesto_detalle))
  end
